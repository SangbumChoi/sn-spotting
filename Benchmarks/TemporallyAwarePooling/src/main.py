...
from dataset import CustomSoccerNetClipsTesting  # ,SoccerNetClipsOld
from dataset import SoccerNetClips, SoccerNetClipsTesting
from loss import NLLLoss
from model import Model
from train import test, testSpotting, trainer
...
def main(args):
    ...
    dataset_Test = CustomSoccerNetClipsTesting(
        path=args.SoccerNet_path,
        features=args.features,
    ...
    for split in args.split_test:
        ...
        logging.info(
            "a_mAP visibility visible per class: " + str(a_mAP_per_class_visible)
        )
        logging.info("a_mAP visibility unshown: " + str(a_mAP_unshown))
        logging.info(
            "a_mAP visibility unshown per class: " + str(a_mAP_per_class_unshown)
        )
